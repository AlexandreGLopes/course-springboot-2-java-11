...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// para salvar um objeto dependente numa relação um para um (ver a classe Payment ou Order) não vamos chamar o repository do próprio objeto
		// faremos primeiramente a associação de mão dupla em memória e depois vamos chamar o repository do pedido
		o1.setPayment(pay1);
